...
def get_conn() -> sqlite3.Connection:
    ...
    # FastAPI runs sync route bodies in a thread pool; deps may resolve on another thread.
    # Same connection must be usable across those threads for a single request.
