...
# Revised prompt (S1-v3, 2026-04-14): add composition field for retrieval.
...

{
  ...
  "composition": "构图摘要，必须是非空字符串，≤ 200 字符；写清楚三点：①镜头远近/取景（如特写、半身、双人同框）②主体相对位置与朝向（如左右、前后、对视/背对）③视觉重心或关键动作落点。"
}
